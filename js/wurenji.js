            ...
            itemStyle: { //---图形形状
                normal: {
                    ...
                    color: function(params) { 
                        var colorList = ['#53c8fe','#419afe','#ed95e3','#366afb']; 
                ...
                series: [{
                    ...
                    itemStyle: { //---图形形状
                        normal: {
                            ...
                            // 定制显示（按顺序）
                            color: function(params) { 
                                var colorList = ['#53c8fe','#419afe','#ed95e3','#366afb','#6975fd']; 
                                return colorList[params.dataIndex] 
                            }
                        },
                    },
